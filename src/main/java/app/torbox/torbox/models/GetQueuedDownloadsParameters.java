...
@EqualsAndHashCode
@Jacksonized
public class GetQueuedDownloadsParameters {
  ...
  /**
   * Determines the queued download requested, will return an object rather than list. Optional.
   */
  private String id;
  ...
  /**
   * The type of the queued download you want to retrieve. Can be "torrent", "usenet" or "webdl". Optional. Default is "torrent".
   */
  private String type;
}
